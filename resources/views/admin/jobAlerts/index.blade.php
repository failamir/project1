...
@can('job_alert_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'JobAlert', 'route' => 'admin.job-alerts.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-JobAlert">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search" strict="true">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\JobAlert::STATUS_SELECT as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-JobAlert:not(.ajaxTable)').DataTable({ buttons: dtButtons })
