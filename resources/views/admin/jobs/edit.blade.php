    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.jobs.update", [$job->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $job->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_posted') ? 'is-invalid' : '' }}" type="text" name="date_posted" id="date_posted" value="{{ old('date_posted', $job->date_posted) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_expired') ? 'is-invalid' : '' }}" type="text" name="date_expired" id="date_expired" value="{{ old('date_expired', $job->date_expired) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('job_description') ? 'is-invalid' : '' }}" name="job_description" id="job_description">{!! old('job_description', $job->job_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('requirement') ? 'is-invalid' : '' }}" name="requirement" id="requirement">{!! old('requirement', $job->requirement) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('procedure_recruitment') ? 'is-invalid' : '' }}" name="procedure_recruitment" id="procedure_recruitment">{!! old('procedure_recruitment', $job->procedure_recruitment) !!}</textarea>
