...
<head>
    ...
    <script nonce="bf824081-63c8-44d7-93cc-0867b118444d">
        (function(w, d) {
            ! function(a, e, t, r) {
                        ...
                        <div class="col-12">
                            ...
                            <div class="invoice p-3 mb-3">
                                    ...
                                    <div class="col-sm-2 invoice-col">
                                        ...
                                        <address>
                                            ...
                                            Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                data-cfemail="0d64636b624d6c61606c7e6c6868697e7978696462236e6260">[email&#160;protected]</a>
                                        </address> --}}
                                        {{-- <img src="https://ppdb.man1mataram.sch.id/storage/app/uploads/public/621/43b/cc4/62143bcc4b4c4045387412.png" width="150" height="150" alt="" srcset=""> --}}
                                    </div>

                                    <div class="col-sm-8">
                                        <img src="{{ url('/md/img/print.png') }}" width="980" height="340" alt="" srcset="">
                                        {{-- To --}}
                                        {{-- <address> --}}
                                            {{-- <div>KEMENTRIAN REPUBLIK INDONESIA</div><br>
                                            <div>KANTOR KEMENTRIAN AGAMA KOTA MATARAM</div><br>
                                            <div>MADRASAH ALIYAH NEGERI 1 MATARAM</div><br>
                                            <div>Jalan Pendidikan No 31 (0370)n621364 Mataram</div><br>
                                            Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                data-cfemail="660c090e084802090326031e070b160a034805090b">[manoene&#160;mataram@yahoo.co.id]</a> --}}
                                        {{-- </address> --}}
                                    </div>
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <a onclick="window.print()" rel="noopener" target="_blank"
