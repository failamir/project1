...
const actions = {
  ...
  insertTandaTanganFile({ commit }, file) {
    commit('insertTandaTanganFile', file)
  },
  removeTandaTanganFile({ commit }, file) {
    commit('removeTandaTanganFile', file)
  },
...
const mutations = {
  ...
  setNip(state, value) {
    state.entry.nip = value
  },
  insertTandaTanganFile(state, file) {
    state.entry.tanda_tangan.push(file)
  },
  removeTandaTanganFile(state, file) {
    state.entry.tanda_tangan = state.entry.tanda_tangan.filter(item => {
